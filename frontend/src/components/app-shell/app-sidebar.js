...
export default function AppSidebar({ role = "cliente" }) {
  ...
  return (
    <aside className="w-full border-b border-zinc-200 bg-white px-4 py-3 md:min-h-screen md:w-64 md:border-b-0 md:border-r">
      <p className="mb-4 text-lg font-semibold text-zinc-900">TechRent</p>
